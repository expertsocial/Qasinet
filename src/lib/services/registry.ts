...
export const MASTER_SERVICES: ServiceDefinition[] = [
  ...
  {
    id: 'safaricom-data',
    title: 'Safaricom Super Bundles',
    shortName: 'Safaricom Bundles',
    category: 'data',
    ...
    logoSrc: '/logos/safaricom-logo.png',
    badge: '🔥 Hot Deals',
    tagline: 'Discounted Data & Minutes',
    description: 'Instant discounted Safaricom data bundles and voice combos. Works with Okoa Jahazi debt.',
    href: '/services/data?network=safaricom',
    defaultStatus: 'enabled',
  },
  {
    id: 'airtel-data',
    title: 'Airtel Bamba Bundles',
    shortName: 'Airtel Bundles',
    category: 'data',
    categoryLabel: 'Data Bundles',
    groupKey: 'airtime_data',
    groupTitle: 'Mobile Airtime & Internet Data',
    logoSrc: '/logos/airtel-logo.jpg',
    badge: '⚡ Best Rates',
    tagline: 'High-Speed Airtel Data',
    description: 'Affordable daily, weekly, and monthly Airtel data packages with instant network delivery.',
    href: '/services/data?network=airtel',
    defaultStatus: 'enabled',
  },
  {
    id: 'faiba-data',
    ...
    description: 'Daily, weekly, and monthly 4G data packages for Faiba lines.',
    href: '/services/data?network=faiba',
    defaultStatus: 'enabled',
  ...
  },
  {
    ...
    comingSoonMessage: 'Kenya Power electricity bill payment is temporarily paused pending gateway channel configuration. Please check back shortly.',
  },
